...
public class MyActivityHubContextListener extends ContextSubscriber {
	...
	private static ContextEventPattern[] getContextSubscriptionParams() {
		...
		cep.addRestriction(
				MergedRestriction.getAllValuesRestriction(ContextEvent.PROP_RDF_SUBJECT, ActivityHubSensor.MY_URI));
		return new ContextEventPattern[] { cep };
	}

	/**
	 * Constructor Registration of context event patterns on the universAAL context
	 * bus
	 *
	 * @param mc
	...
	MyActivityHubContextListener(ModuleContext mc, ActivityHubClient ahc) {
		...
		LogUtils.logInfo(Activator.mc, MyActivityHubContextListener.class, "constructor",
	...
	public void communicationChannelBroken() {
		LogUtils.logWarn(Activator.mc, MyActivityHubContextListener.class, "communicationChannelBroken", null, null);
	}
}
