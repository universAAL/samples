...
public class Activator implements BundleActivator {
	...
	public void stop(BundleContext context) throws Exception {
		...
		if (mc.stop(mc)) // mc.uninstall(mc)
			System.out.println("smp.activityhub.client bundle successfully stopped from OSGiContainer!");
		else
			System.out.println("Problem stopping smp.activityhub.client bundle in OSGiContainer!");
	}
