...
public class SensorSimulatorGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public SensorSimulatorGUI(LocationContextPublisher lp, LampStatePublisher lampStatePublisher,
			RoomTemperaturePublisher roomTemperaturePublisher, RoomHumidityPublisher roomHumidityPublisher) {
		this.lp = lp;
	...
	private void initGUI() {
		...
		sleepingRoomLightBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				LightSource lightSource = lampStatePublisher.getLampMap()
						.getLightSource(LampStatePublisher.SLEEPING_ROOM_LIGHTING);
				...
				lampStatePublisher.changeLabelBackground(lblSleepingRoomLight, lightSource);
		...
		livingRoomLightBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lampStatePublisher.changeLabelBackground(lblLivingRoomLight, lightSource);
		...
		bathroomLightBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lampStatePublisher.changeLabelBackground(lblBathroomLight, lightSource);
		...
		kitchenLightBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lampStatePublisher.changeLabelBackground(lblKitchenLight, lightSource);
			}
		});
		...
		hobbyRoomLightBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				lampStatePublisher.changeLabelBackground(lblHobbyRoomLight, lightSource);
			}
		});
		...
		panel_10.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Sleeping Room Sensor",
		...
		panel_11.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Living Room Sensor",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_13.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Bathroom Sensor",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		final JLabel labelTemp3 = new JLabel(Integer.toString(sliderTemp3.getValue()));
		...
		panel_15.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Kitchen Sensor",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_17.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Hobby Room Sensor",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_7.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Humidity Sensor 1",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panel_8.add(panel_7);
		...
		final JLabel labelHumidity1 = new JLabel(Integer.toString(sliderHumidity1.getValue()));

		sliderHumidity1.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				labelHumidity1.setText(Integer.toString(sliderHumidity1.getValue()));
			}
		});
		...
		sendHumidity1Btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HumiditySensor humiditySensor = new HumiditySensor(HumiditySensor.MY_URI + "humiditySensor1");
		...
		panel_19.setBorder(
				new TitledBorder(null, "Humidity Sensor 2", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		final JLabel labelHumidity2 = new JLabel(Integer.toString(sliderHumidity2.getValue()));

		sliderHumidity2.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				labelHumidity2.setText(Integer.toString(sliderHumidity2.getValue()));
			}
		});
		...
		sendHumidity2Btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				HumiditySensor humiditySensor = new HumiditySensor(HumiditySensor.MY_URI + "humiditySensor2");
		...
		labelCreatedUser.setText("User will be created with following uri: " + USER_NAMESPACE);
		...
		userNameTextField.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				labelCreatedUser.setText(
						"User will be created with following uri: " + USER_NAMESPACE + userNameTextField.getText());
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE + userNameTextField.getText(),
						LOCATION_NAMESPACE + SLEEPING_ROOM);
			}
		});
		panel_4.add(button);
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE + userNameTextField.getText(),
						LOCATION_NAMESPACE + LIVING_ROOM);
			}
		});
		...
		gbl_panel_22.columnWeights = new double[] { 0.0, 0.0, 0.0, Double.MIN_VALUE };
		...
		textFieldUserLocation.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				lblLocationUri.setText("Location uri: " + LOCATION_NAMESPACE + textFieldUserLocation.getText());
		...
		btnSendLocation.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE + userNameTextField.getText(),
						LOCATION_NAMESPACE + textFieldUserLocation.getText());
			}
