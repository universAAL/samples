...
public class SensorSimulatorGUI extends JFrame {
	...
	private void initGUI() {
		setTitle("universAAL - Location Publisher GUI_ver1");
		...
		Image offImage = Toolkit.getDefaultToolkit().createImage(this.getClass().getClassLoader().getResource("lightOff.jpg"));
...
//						lightSource);
		...
		final JLabel labelHumidity1 = new JLabel(
				Integer.toString(sliderHumidity1.getValue()));
		...
		final JLabel labelHumidity2 = new JLabel(
				Integer.toString(sliderHumidity2.getValue()));
		...
		JLabel lbljustName = new JLabel("(Just name)");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE
						+ userNameTextField.getText(), RoomFunction.LivingRoom);
			}
		});
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE
						+ userNameTextField.getText(), RoomFunction.BathRoom);
			}
		});
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE
						+ userNameTextField.getText(), RoomFunction.Kitchen);
			}
		});
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				lp.publishLocation(getSelectedUserType(), USER_NAMESPACE
						+ userNameTextField.getText(), RoomFunction.HobbyRoom);
			}
		});
