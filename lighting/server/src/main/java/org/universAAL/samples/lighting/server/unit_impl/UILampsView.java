...
public class UILampsView extends javax.swing.JPanel {
    ...
    private Map<Integer, Component> lampComponents = new HashMap<Integer, Component>();
	...
	if (lampIDs.length != 4) {
	    throw new UnsupportedOperationException(
		    "Only layoyut of 4 lamps is implemented");
	}
	...
	lampComponent.setLocation(LAMP_OFFSET, VIEW_HEIGHT
		- (LAMP_OFFSET + LAMP_SIZE));
	...
	Component lamp = (Component) lampComponents
		.get(Integer.valueOf(lampID));
	if (lamp != null) {
