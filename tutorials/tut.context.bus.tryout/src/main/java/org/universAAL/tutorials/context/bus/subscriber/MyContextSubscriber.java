...
public class MyContextSubscriber extends ContextSubscriber {
	...
	cep.addRestriction(MergedRestriction.getAllValuesRestriction(
		ContextEvent.PROP_RDF_SUBJECT, LightActuator.MY_URI));
	...
	cep.addRestriction(MergedRestriction.getFixedValueRestriction(
		ContextEvent.PROP_RDF_PREDICATE, ValueDevice.PROP_HAS_VALUE));
	...
	// content.
	LogUtils.logInfo(Activator.mc, MyContextSubscriber.class,
