...
public class Lamp extends Device {
	public static final String MY_URI = TutorialOntology.NAMESPACE + "Lamp";
	public static final String PROP_SOURCE_BRIGHTNESS = TutorialOntology.NAMESPACE + "hasBrightness";
