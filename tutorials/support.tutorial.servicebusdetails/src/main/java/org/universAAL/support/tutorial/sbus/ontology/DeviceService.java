...
public class DeviceService extends Service {
	public static final String MY_URI = TutorialOntology.NAMESPACE + "DeviceService";
	public static final String PROP_CONTROLS = TutorialOntology.NAMESPACE + "controls";
