...
public class MyConcept extends ManagedIndividual {
	...
	public static final String MY_URI = TutorialOntology.NAMESPACE + "MyConcept";
	// Now declare the URI of ALL properties that this concept defines. They
	// must start with lower case.
	public static final String PROP_X_CONCEPT_ONLY_ONE = TutorialOntology.NAMESPACE + "hasSingleDeviceX";
	public static final String PROP_Y_CONCEPT_LIST = TutorialOntology.NAMESPACE + "hasListOfSensorsY";
	public static final String PROP_Z_LITERAL_OPTIONAL = TutorialOntology.NAMESPACE + "hasOptionalLiteralZ";
	...
	public void setY(Sensor[] sens) {
		...
		props.put(PROP_Y_CONCEPT_LIST, propList);
	}
}
