...
public class TV extends ElectricalDevice {
	...
	public static final String DEVICEACTUATOR_NAMESPACE = "http://ontology.univesAAL.org/TV.owl#";
	public static final String MY_URI;
	public static final String PROP_DEVICE_LOCATION;
	public static final String PROP_DEVICE_STATUS;

	static {
		MY_URI = DEVICEACTUATOR_NAMESPACE + "TV";
	...
	public TV(String uri, Location loc, Boolean state) {
		super(uri);
