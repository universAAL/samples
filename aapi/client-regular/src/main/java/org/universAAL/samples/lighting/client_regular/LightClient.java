		...
		if (On == null) {
			On = new AbstractAction("On", null) {
				public void actionPerformed(ActionEvent evt) {
					LightingConsumerLevel1.turnOn((String) jList1.getSelectedValue());
				}
			};
		}
		return On;
	...
	private AbstractAction getOff() {
		if (Off == null) {
			Off = new AbstractAction("Off", null) {
				public void actionPerformed(ActionEvent evt) {
					LightingConsumerLevel1.turnOff((String) jList1.getSelectedValue());
				}
			};
		}
		return Off;
		...
		if (Scale == null) {
			Scale = new AbstractAction("Scale", null) {
				public void actionPerformed(ActionEvent evt) {
					...
					LightingConsumerLevel1.dimToValue(lamp, new Integer(ivalue));
