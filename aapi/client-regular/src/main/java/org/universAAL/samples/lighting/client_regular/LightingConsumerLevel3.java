...
public class LightingConsumerLevel3 {
	...
	public static List<Integer> getControlledLamps() {
		ServiceRequest getAllLampsRequest = new ServiceRequest(
				new LightingSimplified(LightingServerURIs.GetControlledLamps.URI), null);
	...
	public static boolean turnOn(int lampID) {
		AapiServiceRequest turnOnRequest = new AapiServiceRequest(new LightingSimplified(LightingServerURIs.TurnOn.URI),
				null);
		turnOnRequest.addInput(LightingServerURIs.TurnOn.Input.LAMP_URI, lampID);
	...
	public static boolean turnOff(int lampID) {
		AapiServiceRequest turnOffRequest = new AapiServiceRequest(
				new LightingSimplified(LightingServerURIs.TurnOff.URI), null);
		turnOffRequest.addInput(LightingServerURIs.TurnOn.Input.LAMP_URI, lampID);
	...
	public static Object[] getLampInfo(int lampID) {
		...
		getLampInfo.addInput(LightingServerURIs.GetLampInfo.Input.LAMP_URI, lampID);
