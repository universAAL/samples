...
public class LightingSimpleTest extends IntegrationTest {
	...
	LightingInterfaceLevel1 service = (LightingInterfaceLevel1) new SimpleServiceLocator(
		Activator.mc).lookupService(LightingInterfaceLevel1.class);
	...
	LightingInterfaceLevel2 service = (LightingInterfaceLevel2) new SimpleServiceLocator(
		Activator.mc).lookupService(LightingInterfaceLevel2.class);
	LightSource[] controlledLamps = service.getControlledLamps();
	Assert.isTrue(controlledLamps.length == 4);
	int i = 0;
	for (LightSource lamp : controlledLamps) {
	...
	LightingInterfaceLevel3 service = (LightingInterfaceLevel3) new SimpleServiceLocator(
		Activator.mc).lookupService(LightingInterfaceLevel3.class);
    ...
    /**
     * Cross verification of Simplified API vs. Regular API on Level1.
     * Tested combinations:
     * 	- regular server vs. regular client
     *  - regular server vs. simplified client
     *  - simplified server vs. regular client
     *  - simplified server vs. simplified client
     */
    ...
    /**
     * Cross verification of Simplified API vs. Regular API on Level2.
     * Tested combinations:
     * 	- regular server vs. regular client
     *  - regular server vs. simplified client
     *  - simplified server vs. regular client
    ...
    /**
     * Cross verification of Simplified API vs. Regular API on Level3.
     * Tested combinations:
     * 	- regular server vs. regular client
     *  - regular server vs. simplified client
     *  - simplified server vs. regular client
