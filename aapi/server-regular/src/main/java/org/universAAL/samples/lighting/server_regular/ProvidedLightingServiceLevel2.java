...
public class ProvidedLightingServiceLevel2 extends Lighting {
	...
	static {
		...
		OntologyManagement.getInstance().register(Activator.mc,
				new SimpleOntology(MY_URI, Lighting.MY_URI, new ResourceFactory() {
					public Resource createInstance(String classURI, String instanceURI, int factoryIndex) {
						return new ProvidedLightingServiceLevel2(instanceURI);
					}
				}));
		...
		ProvidedLightingServiceLevel2 turnOff = new ProvidedLightingServiceLevel2(LightingServerURIs.TurnOff.URI);
		...
		ProvidedLightingServiceLevel2 turnOn = new ProvidedLightingServiceLevel2(LightingServerURIs.TurnOn.URI);
