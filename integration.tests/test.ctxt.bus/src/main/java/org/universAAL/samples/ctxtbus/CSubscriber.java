...
public class CSubscriber extends ContextSubscriber {
	...
	private static ContextEventPattern[] getPermanentSubscriptions() {
		...
		ceps[0].addRestriction(MergedRestriction
				.getFixedValueRestriction(ContextProvider.PROP_CONTEXT_PROVIDER_TYPE, ContextProviderType.reasoner)
				.appendTo(
