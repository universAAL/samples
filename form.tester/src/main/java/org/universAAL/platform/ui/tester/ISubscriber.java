	...
	public void handleInputEvent(InputEvent event) {
		...
		try {
			if (submit.startsWith("testsubmit")) {
				String[] formsNames = new String[] { "Input 1", "Input 2",
						"Input 3", "Select 1 1", "Select 1 2", "Select M 1",
						"Select M 2", "Area", "Range" };
